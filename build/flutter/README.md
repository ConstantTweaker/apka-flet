...
* `darts_scoreboard` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `darts_scoreboard` - executable or bundle name on disk.
* `darts_scoreboard` - display name shown in window titles and about app dialogs.
